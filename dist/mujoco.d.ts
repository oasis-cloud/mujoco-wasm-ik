...
export interface IkConfiguration extends ClassHandle {
  update(): void;
  updateFromKeyframe(_0: EmbindString): void;
  nq(): number;
  nv(): number;
  q(): any;
  integrateInplace(_0: any, _1: number): void;
  getFramePose(_0: EmbindString, _1: EmbindString): any;
  getCom(): any;
}

export interface IkTask extends ClassHandle {
}

export interface FrameTask extends IkTask {
  setTargetPosQuat(_0: any, _1: any): void;
  setTargetFromConfiguration(_0: IkConfiguration): void;
}

export interface PostureTask extends IkTask {
  setTargetFromConfiguration(_0: IkConfiguration): void;
}

export interface RelativeFrameTask extends IkTask {
  setTargetPosQuat(_0: any, _1: any): void;
  setTargetFromConfiguration(_0: IkConfiguration): void;
}

export interface ComTask extends IkTask {
  setTarget(_0: any): void;
  setTargetFromConfiguration(_0: IkConfiguration): void;
}

export interface DampingTask extends IkTask {
}

export interface EqualityConstraintTask extends IkTask {
}

export interface LookAtTask extends IkTask {
  setTarget(_0: any): void;
  setTargetFromConfiguration(_0: IkConfiguration): void;
}

export interface AxisAlignTask extends IkTask {
  setTarget(_0: any): void;
  setTargetFromConfiguration(_0: IkConfiguration): void;
}

export interface DofFreezingTask extends IkTask {
}

export interface KineticEnergyRegularizationTask extends IkTask {
  setDt(_0: number): void;
}

export interface IkLimit extends ClassHandle {
}

export interface ConfigurationLimit extends IkLimit {
}

export interface VelocityLimit extends IkLimit {
}

export interface CollisionAvoidanceLimit extends IkLimit {
}

export interface FreeJointVelocityLimit extends IkLimit {
}
...
interface EmbindModule {
  ...
  mjVISSTRING: any;
  IkConfiguration: {
    new(_0: MjModel, _1: MjData): IkConfiguration;
  };
  IkTask: {};
  FrameTask: {
    new(_0: EmbindString, _1: EmbindString, _2: number, _3: number, _4: number, _5: number): FrameTask;
  };
  PostureTask: {
    new(_0: MjModel, _1: number, _2: number, _3: number): PostureTask;
  };
  RelativeFrameTask: {
    new(_0: EmbindString, _1: EmbindString, _2: EmbindString, _3: EmbindString, _4: number, _5: number, _6: number, _7: number): RelativeFrameTask;
  };
  ComTask: {
    new(_0: number, _1: number, _2: number): ComTask;
  };
  DampingTask: {
    new(_0: MjModel, _1: number): DampingTask;
  };
  EqualityConstraintTask: {
    new(_0: MjModel, _1: number): EqualityConstraintTask;
    new(_0: MjModel, _1: number, _2: any, _3: number, _4: number): EqualityConstraintTask;
  };
  LookAtTask: {
    new(_0: EmbindString, _1: EmbindString, _2: any, _3: number, _4: number, _5: number): LookAtTask;
  };
  AxisAlignTask: {
    new(_0: EmbindString, _1: EmbindString, _2: any, _3: number, _4: number, _5: number): AxisAlignTask;
  };
  DofFreezingTask: {
    new(_0: MjModel, _1: any): DofFreezingTask;
    new(_0: MjModel, _1: any, _2: number): DofFreezingTask;
  };
  KineticEnergyRegularizationTask: {
    new(_0: number): KineticEnergyRegularizationTask;
  };
  IkLimit: {};
  ConfigurationLimit: {
    new(_0: MjModel): ConfigurationLimit;
    new(_0: MjModel, _1: number): ConfigurationLimit;
  };
  VelocityLimit: {
    new(_0: MjModel, _1: any): VelocityLimit;
  };
  CollisionAvoidanceLimit: {
    new(_0: MjModel, _1: any): CollisionAvoidanceLimit;
    new(_0: MjModel, _1: any, _2: number, _3: number, _4: number, _5: number): CollisionAvoidanceLimit;
  };
  FreeJointVelocityLimit: {
    new(_0: MjModel, _1: any, _2: any): FreeJointVelocityLimit;
    new(_0: MjModel, _1: any, _2: any, _3: EmbindString): FreeJointVelocityLimit;
  };
  solveIK(_0: IkConfiguration, _1: any, _2: any, _3: number, _4: number): any;
  solveIK(_0: IkConfiguration, _1: any, _2: any, _3: number, _4: number, _5: any): any;
}
